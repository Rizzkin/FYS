...
public class Gevonden_bagageController implements Initializable {
    ...
    void on_Opslaan(ActionEvent event) {
        ...
        System.out.println(ddlMerk.getSelectionModel().getSelectedItem().toString() + " " + get_Brand_id());
        System.out.println(ddlWeight.getSelectionModel().getSelectedItem().toString() + " " + get_Weight_id());
    ...
    void on_Foto_bestand(ActionEvent event) {
        ...
        // hier kun je alleen maar een bestand selecteren
...
//            image = new Image(file.toURI().toString(), 120, 150, true, true); // locatie, width, height, image blijft hetzelfde
//            imgLuggage = new ImageView(image);
//            imgLuggage.setFitWidth(120);
//            imgLuggage.setFitHeight(150);
//            imgLuggage.setPreserveRatio(true);
